...
public class DatasetServiceImpl implements DatasetService {
    ...
    public DatasetDTO findOne(Long id, Integer version) {
        ...
        datasetPrivilegeService.fillDatasetFieldAuthorize(datasetDTO, SecurityContextHolder.getUserName());
    ...
    public PageVO<DatasetVO> search(DatasetQuery datasetQuery) {
        ...
        List<DatasetDTO> datasetDTOS = pageInfo.getList().stream().map(dataset -> {
            ...
            if(datasetQuery.getFolderType() == FolderTypeEnum.ALL) {
                ...
                folder = folderService.findPersonalByTarget(dataset.getId(), PositionEnum.DATASET, SecurityContextHolder.getUserName());
            }
            if (!Objects.isNull(folder)) {
    ...
    public DatasetDTO save(DatasetDTO datasetDTO) {
        ...
        try {
            ...
            dataset.setCreator(SecurityContextHolder.getUserName());
            dataset.setOperator(SecurityContextHolder.getUserName());
    ...
    public DatasetDTO update(DatasetDTO datasetDTO, Long id) {
        ...
        try {
            ...
            datasetDTO.setOperator(SecurityContextHolder.getUserName());
