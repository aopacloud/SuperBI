...
public class DatasetApplyServiceImpl implements DatasetApplyService {
    ...
    public List<DatasetApplyDTO> search(DatasetApplyQuery query) {
        ...
        if(sysUserService.isSuperAdmin(SecurityContextHolder.getUserName())) {
    ...
    public DatasetApplyDTO postApply(DatasetApplyDTO datasetApplyDTO) {
        ...
        List<DatasetApplyDTO> datasetApplyDTOS = datasetApplyMapper.selectByDatasetAndUsername(datasetApplyDTO.getDatasetId(), SecurityContextHolder.getUserName());
        ...
        datasetApply.setUsername(SecurityContextHolder.getUserName());
        datasetApply.setAliasName(sysUserService.getUserAliasName(SecurityContextHolder.getUserName()));
    ...
    public ApplyMessageDTO getApplyMessage() {
        ...
        int applyingCount = datasetApplyMapper.selectApplyingCount(SecurityContextHolder.getUserName());

        int reviewCount = datasetApplyMapper.selectReviewCount(SecurityContextHolder.getUserName());

        int operationCount = datasetApplyMapper.selectOperationCount(SecurityContextHolder.getUserName());
