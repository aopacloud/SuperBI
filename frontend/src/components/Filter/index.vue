...
import FilterAssembly from './Assembly.vue'
...
const assemblyRef = ref(null)
const datepickerRef = ref(null)
const filterTextRef = ref(null)

const init = () => {
  nextTick(() => {
    assemblyRef.value?.init()
...
const isNested = computed(() => props.field.nested)

// 日期筛选
const isDate = computed(
  () => !isNested.value && props.field.dataType?.includes('TIME')
)
