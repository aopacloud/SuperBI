...
export const presetOptions = [
  ...
  // { label: '今天', value: 0, type: 'day' },
  { label: '昨天', value: -1, type: 'day', col: 50 },
  { label: '上周', value: -1, type: 'week', col: 50 },
  { label: '本周', value: 0, type: 'week', col: 50 },
  { label: '上月', value: -1, type: 'month', col: 50 },
  { label: '本月', value: 0, type: 'month', col: 50 },
